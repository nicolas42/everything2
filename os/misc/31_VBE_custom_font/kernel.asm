...
;;    cli                   ; clear interrupts
    hlt                     ; halt cpu
        ...
        ;; Include Files
        ;; --------------------------------------------------------------------
		include "include/print_char.inc"
		include "include/print_string.inc"
        include "include/print_hex.inc"
        include "include/print_registers.inc"
		include "include/print_fileTable.inc"
		include "include/clear_screen.inc"
		include "include/move_cursor.inc"
		include "include/hex_to_ascii.inc"
		include "include/file_ops.inc"
        include "include/get_key.inc"
